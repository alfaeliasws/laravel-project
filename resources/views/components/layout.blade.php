...
<body class="bg-bluemain-dark-3 justify-between min-w-screen min-h-screen">
    <x-navbar class="shadow-inherit"/>
    <div class="mb-auto">
        {{$slot}}
    </div>    
    <div class="sticky top-[100vh] min-h-[100px] text-center py-9 w-full bg-bluemain-dark-4 check mt-auto">
        <div class="mx-10">
