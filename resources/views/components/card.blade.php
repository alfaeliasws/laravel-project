...
<div {{$attributes->merge(['class' => 'sm:w-6/12 lg:w-4/12 2xl:w-3/12 mx-auto check'])}}>
    <a href="/listings/{{$listing->id}}" class="hover:saturate-150 text-gray-300 transition-all">
        <div class="xl:mx-8 sm:mx-3 bg-bluemain-dark-4 hover:bg-bluemain-dark-1 2xl:px-4 xl:px-2 lg:px-4 px-5 py-8 md:px-5 md:py-9 sm:py-8 mb-10 xl:py-5 lg:py-7 rounded-2xl shadow-new hover:pb-9 hover:mb-6 transition-all duration-500">
            ...
            <p class="xl:ml-3 md:ml-0 sm:ml-3 xl:tracking-wider xl:text-lg lg:text-md text-lg sm:mb-1 mb-2">{{$listing->species_name}}</p>
            <p class="xl:ml-3 md:ml-0 sm:ml-3 xl:tracking-wider xl:text-sm lg:text-xs text-sm sm:mb-1 mb-2">Batch: {{$listing->group}}</p>
        </div>
    </a>
</div>